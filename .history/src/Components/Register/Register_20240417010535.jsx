          ...
          <div className="bg-light bg-opacity-25 shadow w-100 mx-auto  p-5 rounded-2">
            ...
            <div className="pt-3">
              <form onSubmit={formik.ha}>
                ...
                />
                {formik.touched.name?<p className=" alert alert-danger">{formik.errors.name}</p>:''}
                <input
                  className="form-control my-2"
                  type="email"
                  name="email"
                ...
                />
                {formik.touched.email?<p className=" alert alert-danger">{formik.errors.email}</p>:''}
                ...
                />                
                {formik.touched.password?<p className=" alert alert-danger">{formik.errors.password}</p>:''}
                ...
                />                
                {formik.touched.age?<p className=" alert alert-danger">{formik.errors.age}</p>:''}
                ...
                />               
                {formik.touched.phone?<p className=" alert alert-danger">{formik.errors.phone}</p>:''}
