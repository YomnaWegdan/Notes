...
export default function Register() {
  ...
  let [signUpMsgError , setSignUpMsgError]= useState([])
          ...
          <div className="bg-light bg-opacity-25 shadow w-100 mx-auto  p-5 rounded-2">
            ...
            <div className="pt-3">
              <form onSubmit={formik.handleSubmit}>
                ...
                {signUpMsgError?<p>{signUpMsgError}</p>:''}

              </form>
              <p>Already Have Account ? <Link to={'./login'} className=" text-info text-decoration-none fw-bold">Login</Link></p>
            </div>
          </div>
        </div>
      </div>
