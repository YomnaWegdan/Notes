    ...
    <>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button variant="info" onClick={formik.handleSubmit}>
            Add Note
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <div className="overflow-hidden">
        <div className="row">
          ...
          <div className="col-10 px-lg-5 px-2 py-5 bg-light min-vh-100">
            <div className="text-end me-2">
              <Button variant="primary" onClick={handleShow} className="btn btn-info text-white mt-4">
                <i className="fa-solid fa-plus"></i> Add Note
              </Button>
            </div>
            <div className="row gy-4 gx-5 mt-3">
...
React Awesome Reveal: for animation  based on animate.css
*/