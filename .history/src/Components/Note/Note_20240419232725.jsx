...
export default function Note({note , getUserNotes}) {
  ...
  return (
    ...
    <Card.Body>
      ...
      <Button className=" btn-info"><i variant="primary" onClick={handleShow} className=" fa-solid fa-pen-to-square "></i></Button>
      <Button className=" btn-info"></Button><i onClick={deleteNote} className=" fa-solid fa-trash"></i></B
      </div>
    </Card.Body>
  </Card></Slide>
  </div>
