...
export default function Note({note , getUserNotes}) {
  ...
  return (
    ...
    <Card.Body>
      ...
      <Button className="btn btn-outline-info"><i variant="primary" onClick={handleShow} className=" fa-solid fa-pen-to-square "></i></Button>
      <i onClick={deleteNote} className=" fa-solid fa-trash"></i>
      </div>
    </Card.Body>
  </Card></Slide>
  </div>
